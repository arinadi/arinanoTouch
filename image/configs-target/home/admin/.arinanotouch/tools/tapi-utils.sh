#!/bin/bash
# ═══════════════════════════════════════════
#  arinanoTouch — Termux:API Bridge Utilities
#  Source this in .bashrc: source ~/.arinanotouch/tools/tapi-utils.sh
# ═══════════════════════════════════════════
...
clipboard-watch() {
    ...
    nohup bash ~/.arinanotouch/tools/clipboard-sync.sh > /dev/null 2>&1 &
    echo "Clipboard sync started (Android ↔ proot)."
}

echo "📱 arinanoTouch TAPI utils loaded. Try: battery, clipget, clipset, bright 50, buzz"
